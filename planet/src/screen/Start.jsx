...
function Body() {
  return (
    <div className="m-auto z-50">
      ...
      <div
        style={{ fontFamily: "jetbrains_valiable" }}
  ...
  return (
    <div className="max-w-xl sm:mx-w-2xl md:max-w-3xl lg:max-w-5xl py-4 flex justify-between mx-auto text-lg">
      <div className="flex items-center space-x-4">
        ...
        <p className="text-xl" style={{ fontFamily: "jockey" }}>
          Planet
        </p>
      </div>
      <div
        style={{ fontFamily: "jetbrains_valiable" }}
        className="space-x-4 flex items-center text-gray-600"
      >
        <Link to="/Login">Login</Link>
        <Link
          to="/Signup"
          className="px-4 py-1 rounded-full border border-gray-600 hover:text-white hover:border-blue-300 hover:bg-blue-300 duration-500"
        >
          SignUp
        </Link>
      </div>
...
function Start(props) {
  return (
    ...
    >
      <img
        className="hidden md:block absolute w-48 bottom-3 left-0 bg-cover"
        src={Bg_left}
        alt=""
      />
      <img
        className="hidden md:block absolute w-48 bottom-3 right-0 bg-cover"
        src={Bg_right}
        alt=""
      />
      <Navbar />
